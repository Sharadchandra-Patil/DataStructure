...
bool_t is_queue_full(queue_t *pq)
{
    //if front is at next position of rear
...
void dequeue(queue_t *pq)
{
    if( pq->front == pq->rear )//if we are deleting last ele
        pq->front = pq->rear = -1;//reinitialised cir queue
    else
...
//programming is a skill, and can be improved only by "practice"
//if you are "expert" in c programming language, 
//you can become "expert" in any programming language
